            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ 'Rp. ' . number_format($total_pendapatan_harian) }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pesanan_tertunda }}</div>
                    </div>
                    <div class="col-auto">
...
@section('scripts')
    ...
    <script>
        ...
        var listBulan =  @json(array_values($listBulan));
        var totalPendapatanList =  @json(array_values($totalPendapatanList));
        var maxValue = {{ json_encode($maxTotalPendapatan) }};
    ...
    {{-- Script Chart Donut --}}
    <script>
        var menuCategories = @json(array_values($menuCategories));
        var menuCategoryCounts = @json(array_values($menuCategoryCounts));
