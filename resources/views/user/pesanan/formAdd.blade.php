                ...
                <form action="{{ route('pesanan.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="input-group mb-3 has-validation">
                            ...
                            <input type="number" class="form-control {{ $errors->has('total_pesanan') ? 'is-invalid' : '' }}" id="total_pesanan" name="total_pesanan" value="{{ (!Cart::content()->isEmpty()) ? $totalWithoutTax : old('total_pesanan') }}" readonly>
